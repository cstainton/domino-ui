...
/**
 * Internal holder pairing a {@link DominoHistory.StateListener} with its {@link TokenFilter} and a
 * flag indicating whether the listener should be removed after it fires once.
 */
